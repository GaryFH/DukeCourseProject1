...
## Part 1: Data
### _**TASK:**_ ####    Assignment is to learn what attributes make a movie popular with the goal of creating a predictive algorithm with the response variable being a movies popularity.   
* * *
...
#####Note that after Exploratory data analysis and preprocessing of the dataframe, **the number of variables** used for statistical analysis was **reduced from 32 down to only 15**.
...
####No significant correlation between the variables was found
####The residuals are _**distributed around 0**_ - from the Residual Distribution Plot
####**_Nearly normal residuals_**: By looking at the histogram and Q-Q plot
####From Residuals Distribution Plot - Residuals have _**constant variability**_.
```{r,warning=FALSE,message=FALSE}
